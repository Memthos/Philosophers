...
For the bonus part, instead of using mutexes, we need to use semaphores. This means that the forks are not beside each philosopher but at the enter of the table. Beside this, the philosophers are now child processes of our program.
...
# Same as above, but stops when each philosopher has eaten at least 7 times
```

## Resources

AI was used to check spelling errors.
